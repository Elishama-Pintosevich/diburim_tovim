...
from routes import IvrBlueprint, UsersBlueprint, BpnBlueprint, CalendarBlueprint, ActionsBlueprint, SoundBlueprint, TokenBlueprint, CallsBlueprint
...
def create_app():
    ...
    api.register_blueprint(CallsBlueprint)
