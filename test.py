...
date_list = [datetime(2024, 7, 15),datetime(2024, 7, 16),datetime(2024, 7, 17),datetime(2024, 7, 18),datetime(2024, 7, 19),datetime(2024, 7, 20),
             datetime(2024, 7, 21),datetime(2024, 7, 22),datetime(2024, 7, 23),datetime(2024, 7, 24),datetime(2024, 7, 25),datetime(2024, 7, 26),
             datetime(2024, 7, 27)]
...
def check_nearest_end_week_exist(dates):
    ...
    # today = 7
    remainUntil5 = (5 - (today - 7)) % 7 #אם זה יום שישי מה עושים - 6 זה בעצם עוד 6 ימים אם זה שבת אז עוד 5 ימים אולי לעשות מינוס 7 אם זה 1 אז זה יהיה מינוס
